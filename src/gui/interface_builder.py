...
class InterfaceBuilder:
    ...
    def _create_views(self):
        ...
        # --- Column 1: Conversion Status Panel (shows loaded/converted files) ---
        ...
        # --- Column 2: Transcription Queue Panel (files waiting for processing) ---
        ...
        # --- Column 3: Completed Files Panel (successfully transcribed files) ---
