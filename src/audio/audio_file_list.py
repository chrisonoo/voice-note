...
def get_audio_file_list(input_directory):
    """
    Przeszukuje podany katalog, znajduje wszystkie pliki pasujące do zdefiniowanych
    rozszerzeń (`config.AUDIO_EXTENSIONS`) i zapisuje ich pełne, absolutne ścieżki
    ...
    with open(config.AUDIO_LIST_TO_ENCODE_FILE, 'w', encoding='utf-8') as f:
        # `os.walk` rekursywnie przechodzi przez podany katalog i jego podkatalogi.
